...
#ifdef SENSOR_INCLUDED_ATK_MS901M
...
#ifdef SENSOR_INCLUDED_ATK_MS901M
  {
    .implements = SensorImplementation_atk_ms901m,
    .init = sensorsAtkMs901mInit,
    .test = sensorsAtkMs901mTest,
    .areCalibrated = sensorsAtkMs901mAreCalibrated,
    .manufacturingTest = sensorsAtkMs901mManufacturingTest,
    .acquire = sensorsAtkMs901mAcquire,
    .waitDataReady = sensorsAtkMs901mWaitDataReady,
    .readGyro = sensorsAtkMs901mReadGyro,
    .readAcc = sensorsAtkMs901mReadAcc,
    .readMag = sensorsAtkMs901mReadMag,
    .readBaro = sensorsAtkMs901mReadBaro,
    .setAccMode = sensorsAtkMs901mSetAccMode,
